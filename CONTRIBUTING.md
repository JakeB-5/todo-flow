...
Record behavior, compatibility and important fixes under `Unreleased`. Only assign a release version/date when publishing a release; a development package version is not evidence of a remote release.
